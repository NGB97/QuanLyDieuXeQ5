...
public partial class DanhMuc_DanhMucNguoiDung_CapNhat : System.Web.UI.Page
{
    string sIdNguoiDung = "";
    string Page = "";
    string mTenDangNhap = "";
    ...
    private void LoadQuyen()
    {
        ...
        slQuyen.DataBind();
        slQuyen.Items.Add(new ListItem("Chọn quyền", "0"));
        slQuyen.Items.FindByText("Chọn quyền").Selected = true;
    }
