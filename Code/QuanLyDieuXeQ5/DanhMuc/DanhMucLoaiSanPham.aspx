<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/MasterPage.master" AutoEventWireup="true" CodeFile="DanhMucLoaiSanPham.aspx.cs" Inherits="DanhMuc_DanhMucLoaiSanPham" %>
    ...
    <script>
        function DeleteLoaiSanPham(idLoaiSanPham) {
            if (confirm("Bạn có muốn xóa không ?")) {
                ...
                xmlhttp.open("GET", "../Ajax.aspx?Action=DeleteLoaiSanPham&idLoaiSanPham=" + idLoaiSanPham, true);
                xmlhttp.send();
            }
        }
    </script>
                            ...
                            <div class="container-fluid">
                                <div class="form-group row-fluid">
                                    ...
                                    <div class="span8 CanhPhai">
                                        ...
                                        <a class="btn btn-primary" href="DanhMucLoaiSanPham-CapNhat.aspx"><i class="fa fa-plus"></i><span>Thêm mới</span></a>
                                ...
                                <div class="form-group row-fluid">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Tìm kiếm theo tên loại sản phẩm" id="txtTenLoaiSanPham" runat="server" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row-fluid">
                                    ...
                                    <div class="span12">
                                        ...
                                        <div id="dvDanhSachLoaiSanPham" style="overflow: auto; margin-top: 10px" runat="server">
                                        </div>
