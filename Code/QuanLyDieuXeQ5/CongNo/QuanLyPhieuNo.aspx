<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/MasterPage.master" AutoEventWireup="true" CodeFile="QuanLyPhieuNo.aspx.cs" Inherits="QuanLyXuatKho_QuanLyXuatKho" %>
            ...
            <div class="form-group row-fluid">
                ...
                <div class="col-lg-4">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="Tên KH, Mã KH" id="txtTenKhachHang" runat="server" />
