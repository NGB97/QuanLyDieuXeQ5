<%@ Page Title="" enableEventValidation="false" Language="C#" MasterPageFile="~/Layout/MasterPage.master" AutoEventWireup="true" CodeFile="CongNoKhachHang-CapNhat.aspx.cs" Inherits="QuanLyDonHang_QuanLyDonHang_CapNhat" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script>
        ...
        function DeleteChiTietDonHang(idChiTietDonHang) {
            ...
            function LoadKhachHang(idKhachHang) {

                idKhachHang = '<%= Request.QueryString["idKhachHang"] %>';
                if (Loai == "XuatBan") {
                    //alert(idHangHoa);
                    //var idNhapMua = $('#ContentPlaceHolder1_slMaNhapMua').val();
                    var xmlhttp;
                    //alert(idNhapMua);
                    if (window.XMLHttpRequest) {// code for IE7+, Firefox, Chrome, Opera, Safari
                        xmlhttp = new XMLHttpRequest();
                    ...
                    xmlhttp.onreadystatechange = function () {
                        if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                            if (xmlhttp.responseText != "") {
                                ...
                                $('#ContentPlaceHolder1_txt_SoLuongTon').val(xmlhttp.responseText.split('-')[0]);
                                //if (Loai == "XuatTra") {
                                //    $('#ContentPlaceHolder1_txtDonGia').val(xmlhttp.responseText.split('-')[1]);
                                //    $('#ContentPlaceHolder1_txtCK').val(xmlhttp.responseText.split('-')[2]);
                                //}
                    ...
                    xmlhttp.open("GET", "../Ajax.aspx?Action=LoadKhachHang&idKhachHang=" + idKhachHang, true);
                    xmlhttp.send();
                }
            }
    </script>
                ...
                <div style="padding-left: 2%">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-7">
                                <input placeholder="Số tiền trả" oninput="LoadTienTraNo(this)" class="form-control" data-val="true" data-val-required="" id="txtSoTienTra" runat="server" name="Content.ContentName" type="text" value="" />
                            </div>
                        </div>
