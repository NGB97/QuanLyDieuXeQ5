...
public static class Connect
{
    ...
    {
      // string s = @"Data Source=LAPTOP-42TMEKGS\SQLEXPRESS;Initial Catalog=db_QuanLyCongNoAnhKiet;Integrated Security=True";
       // string s = @"Data Source=45.119.83.44, 1433;Initial Catalog=db_QuanLyCongNoAnhKiet;User ID=anhkiet; Password=123;Connect Timeout=10";
        string s = @"Data Source=27.0.15.8, 1433;Initial Catalog=db_xecohai;User ID=login123 ; Password=123;Connect Timeout=10";
       // string s = @"Data Source=DESKTOP-GC26VVV\SQLEXPRESS;Initial Catalog=db_AnhTuyen;Integrated Security=True";
