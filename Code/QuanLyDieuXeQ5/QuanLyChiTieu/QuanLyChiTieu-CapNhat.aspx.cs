...
public partial class QuanLyChiTieu_QuanLyChiTieu_CapNhat : System.Web.UI.Page
{
    ...
    private void LoadThongTinChiTieu()
    {
        if (sIdChiTieu != "")
        {
            string sql = "select * from tb_ChiKhac where idChiKhac='" + sIdChiTieu + "'";
    ...
    protected void btLuu_Click(object sender, EventArgs e)
    {
        ...
        if (sIdChiTieu == "")
        {
            string sqlInsertChiTieu = "insert into tb_ChiKhac(NgayChi,NoiDung,SoTien,idNguoiDung)";
            sqlInsertChiTieu += " values('" + NgayChi + "',N'" + NoiDung + "','" + SoTien + "','" + mIdNguoiDung + "')";
