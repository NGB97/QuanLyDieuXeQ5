<%@ Page Title="" enableEventValidation="false" Language="C#" MasterPageFile="~/Layout/MasterPage.master" AutoEventWireup="true" CodeFile="QuanLyHangTaiVanPhong-CapNhat.aspx.cs" Inherits="QuanLyDonHang_QuanLyDonHang_CapNhat" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script>
        ...
        function DeleteChiTietDonHang(idChiTietDonHang) {
            ...
            function LoadSanPham1(idChiNhanh) {
                //var idKhachHang = document.getElementById("ContentPlaceHolder1_hdIdKhachHang").value;
                //alert(idChiNhanh);
                var xmlhttp;
                if (window.XMLHttpRequest) {// code for IE7+, Firefox, Chrome, Opera, Safari
                ...
                xmlhttp.onreadystatechange = function () {
                    if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                        if (xmlhttp.responseText != "") {
                            ...
                            alert("Lỗi! Xe này Không có hàng hóa nào.")
                        }

                    }
                }
                xmlhttp.open("GET", "../Ajax.aspx?Action=SanPhamAutocomplete&idChiNhanh=" + idChiNhanh, true);
                xmlhttp.send();
            }
            ...
            function LoadSanPham(idDonHang)
            {
                var xmlhttp;
                if (window.XMLHttpRequest) {// code for IE7+, Firefox, Chrome, Opera, Safari
                    xmlhttp = new XMLHttpRequest();
            ...
            var listsanpham2 = [];
            function DSSanPham(value, Loai, idChiTietDonHang) {
              //  alert(Loai)
                if(value)
                {
            ...
            function ThemSanPham() {
                for (var i = 0; i < listsanpham.length; i++)
                {
                   ...
                   // listSanPham1 = $("#ContentPlaceHolder1_listSanPham").val().split(',');
               ...
               // TongTien = Number($("#ContentPlaceHolder1_txtTongTien").val().split(' ')[0].replace(/\./g, ''));
                ...
                //var MaDonHang = $('#chk').val();
                //var idDonHang = $('#ContentPlaceHolder1_hdIDChonDonHang').val();
                //var IDChiTietDonHang = $('#ContentPlaceHolder1_hdIDChonSanPham').val();
                //var TenSanPham = $('#ContentPlaceHolder1_txtChonSanPham').val();

                //var SoLuong = $('#ContentPlaceHolder1_hdSoLuong').val();
                ...
                <div style="padding-left: 2%">
                    <div class="row-fluid paddingbuttom30">
                        <div class="span12 title1">
                            <div class="span6">
                                <a href="../QuanLyHangTaiVanPhong/QuanLyHangTaiVanPhong.aspx" runat="server"><i class="fa fa-arrow-left" style="padding-right: 5px"></i>Quay lại</a>
                            </div>
                            <div class="span6">
                    ...
                    <div  class="col-md-6">
                        ...
                        <div hidden="hidden" class ="col-md-12">
                         ...
                         <div hidden="hidden" class="col-md-12" style="text-align: center" id ="dvsanpham">
                            <div class="col-md-3">
                                <input type="radio" checked="" name="tra" class='flat-red' runat="server" />
                                <a />
                                SP1: <br />
                            ...
                            <thead style='white-space: nowrap;'>
                                <tr id="tr_SanPham">
                                    ...
                                    <th class='th' style='background-color: #1c9c13; font-size: 15px; color: white;'>Tên Hàng Hóa
                                     ...
                                     <th class='th' style='background-color: #1c9c13; font-size: 15px; color: white;'>Hàng đến văn phòng 
                                    </th>
                                     <th class='th' style='background-color: #1c9c13; font-size: 15px; color: white;'>Đã hoàn thành
                                    </th>
