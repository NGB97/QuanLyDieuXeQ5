<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/MasterPage.master" AutoEventWireup="true" CodeFile="QuanLyHangTaiVanPhong.aspx.cs" Inherits="QuanLyDonHang_QuanLyDonHang" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script>
        ...
        function ChonThanhToan(value, idHangHoa) {
            //var chuoi = chuoiLuuDot;
            var xmlhttp;
            ...
            xmlhttp.open("GET", "../Ajax.aspx?Action=ChonThanhToan&idHangHoa=" + idHangHoa + "&TT=" + value, true);
            xmlhttp.send();
        }
        ...
        function PrinfBienNhanXuongVP(idDonHang) {
            ...
            xmlhttp.open("GET", "../Ajax.aspx?Action=PrinfBienNhanXuongVP&idHD=" + idDonHang, true);
            xmlhttp.send();
        }
    </script>
</asp:Content>
        ...
        <div class="container-fluid">
            <div class="form-group row-fluid">
                ...
                <div class="span8 CanhPhai">
                    ...
                    <a id="btThemMoi" runat="server" class="btn btn-primary" href="QuanLyHangTaiVanPhong-CapNhat.aspx"><i class="fa fa-plus"></i><span>Thêm mới</span></a>
