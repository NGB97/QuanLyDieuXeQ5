<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/MasterPage.master" AutoEventWireup="true" CodeFile="HangHoaCho.aspx.cs" Inherits="ThongKe_ThongKeNhanVienThuTien" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script>
        ...
        function PrinfBienNhanXeCho(idDonHang) {
            ...
            xmlhttp.open("GET", "../Ajax.aspx?Action=PrinfBienNhanXeCho&idHD=" + idDonHang, true);
            xmlhttp.send();
        }
         </script>
</asp:Content>
                ...
                <div class="container-fluid">
                                <div class="form-group row-fluid">
                                    <div class="span4 title1">
                                        <b>THÔNG KÊ HÀNG HÓA ĐANG VẬN CHUYỂN</b>
                                    </div>
                                ...
                                <div class="form-group row-fluid">
                                    ...
                                    <div hidden ="hidden" style ="display:none" class="col-lg-3">
                                        <div class="input-group">
