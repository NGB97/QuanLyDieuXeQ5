<%@ Page Language="C#" MasterPageFile="~/Layout/MasterPage.master" AutoEventWireup="true" CodeFile="QuanLyVeXe.aspx.cs" Inherits="QuanLyVeXe_QuanLyVeXe" %>
        ...
        <div class="container-fluid">
            <div class="form-group row-fluid">
                ...
                <div class="span8 CanhPhai">
                    ...
                    <a id="btThemMoi" runat="server" class="btn btn-primary" href="QuanLyVeXe-CapNhat.aspx"><i class="fa fa-plus"></i><span>Thêm Vé Bán</span></a>
            ...
            <div class="form-group row-fluid">
                <div class="col-md-3">
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-x fa-building-o"></i></span>
                        <input placeholder="Điểm Khởi Hành" class="form-control" data-val="true" data-val-required="" id="txtChiNhanhNhan" runat="server" name="Content.ContentName" type="text" value="" />
                ...
                <div class="col-md-3">
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-x fa-building-o"></i></span>
                        <input type="text" class="form-control" placeholder="Điểm Đi" id="txtTenKhachHang" runat="server" />
                ...
                <div class="col-md-3">
                    <div  class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="Ngày Khởi Hành" id="txtTuNgay" runat="server" />
                    </div>
                    
                </div>
                <div class="col-md-3">
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-x fa-clock-o"></i></span>
                        <input type="text" class="form-control" placeholder="Giờ Khởi Hành" id="txtDenNgay" runat="server" />
