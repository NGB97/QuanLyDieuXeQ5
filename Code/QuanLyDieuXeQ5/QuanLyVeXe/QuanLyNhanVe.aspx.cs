...
public partial class QuanLyVeXe_QuanLyNhanVe : System.Web.UI.Page
{
    int SoHoaDon = 0;
...
where dh.idDonHang = ct.idDonHang  and kh.idKhachHang = dh.idKhachHang";
        ...
        //Tình Trạng Được Trả Hàng
        sql += "and tb1.MaTinhTrang <> 'DHT'";
        ...
        if (table.Rows.Count > 0)
        {
            ...
            for (int i = 0; i <= table.Rows.Count; i++)
            {
                ...
                if (STT != (i < table.Rows.Count ? table.Rows[i]["RowNumber"].ToString() : "-1") || i == table.Rows.Count)
                {
                    ...
                    html += "       <td style='text-align:center;vertical-align: inherit;'>" +"14/4/2019"+ "</td>";
                    html += "       <td style='text-align:center;vertical-align: inherit;'>" + "15/4/2019" + "</td>";
                    html += "       <td style='text-align:center;vertical-align: inherit;'>" + "2 giờ" + "</td>";
                    html += "       <td style='text-align:center;vertical-align: inherit;'>" + "Ghế A1" + "</td>";
                    html += "       <td style='text-align:center;vertical-align: inherit;'>" + "Nguyễn Văn A" + "</td>";
                    html += "       <td style='text-align:center;vertical-align: inherit;'>" + "11/4/2019" + "</td>";
                    html += "       <td style='text-align:center;vertical-align: inherit;'>" + "5" + "</td>";
                    html += "       <td style='text-align:center;vertical-align: inherit;'>" +"220.000" + "</td>";
                    html += "       <td style='text-align:center;vertical-align: inherit;'>" + "Đã Thanh Toán" + "</td>";
                    html += "       <td style='text-align:center;vertical-align: inherit;'>" + "1.100.000" + "</td>";
                    html += "       <td style='text-align:center;vertical-align: inherit;'> <a class='btn btn-primary' title='Sửa đơn hàng' onclick='window.location=\"ThanhToan-DonHang.aspx?Page=" + Page.ToString() + "&idDonHang=" + table.Rows[j]["idDonHang"].ToString() + "\"'><i class='fa fa-money'></i><span> Hủy Vé </span></a></td>";
                    html += "       <td style='text-align:center;vertical-align: inherit;'> <a class='btn btn-primary' href='#' onclick='PrinfHoaDon1(\"" + table.Rows[j]["idDonHang"] + "\")'><i class='fa fa-print'> Xuất Vé</i></a></td>    ";
                    ...
                    html += "                               <th class='th' style='background-color: #1c9c13; font-size: 15px; color: white;'>Mã HĐ</th>";
                    html += "                              <th class='th' style='background-color: #1c9c13; font-size: 15px; color: white;'>Tên Khách Hàng</th>";
                    html += "                              <th class='th' style='background-color: #1c9c13; font-size: 15px; color: white;'>Ngày Đi</th>";
                    html += "                              <th class='th' style='background-color: #1c9c13; font-size: 15px; color: white;'>Giờ Đi</th>";
                    ...
                    {
                        html += "           <a class='btn btn-primary' title='Sửa đơn hàng' onclick='window.location=\"ThanhToan-DonHang.aspx?Page=" + Page.ToString() + "&idDonHang=" + table.Rows[j]["idDonHang"].ToString() + "\"'><i class='fa fa-money'></i><span> Hủy Vé </span></a>";
                    }
                    ...
                    html += "          <a class='btn btn-primary' href='#' onclick='PrinfHoaDon1(\"" + table.Rows[j]["idDonHang"] + "\")'><i class='fa fa-print'> Xuất Vé</i></a>    ";
                    //html += "       </td>";
                ...
                if (i < table.Rows.Count)
                {
                    ...
                    htmlct += "<td style='text-align:center;vertical-align: inherit;'> " + "Nguyễn Văn A" + "</td>";
                    htmlct += "<td style='text-align:center;vertical-align: inherit;'> " +"15/4/2019" + "</td>";
                    htmlct += "<td style='text-align:center;vertical-align: inherit;'>" + "2 giờ" + "</td>";
                    htmlct += "<td style='text-align:center;vertical-align: inherit;'> " + "220.000" + "</td>";
                    
                    htmlct += "<td style='text-align:center;vertical-align: inherit;'> " + "Đã Thanh Toán" + "</td>";
